...
function Projects() {
  return (
    <div className="text-light min-h-screen w-full pb-10 mt-28 md:mt-64">
      <div className="w-full h-full max-w-6xl mx-auto flex justify-center flex-col px-7 lg:px-3">
        ...
        <div>
          <h2 className=" md:mb-5 tracking-wide md:text-xl font-extralight md:text-start text-center">
